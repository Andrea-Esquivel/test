...
* [Login with existing email and edit/delete the email](#login-edit-email)
...
* [Successful link redirects](#redirects-successful)
...
## <a id="login-edit-email">🔏 Login with existing email and edit/delete the email</a>
...
## <a id="redirects-successful">🔗 Successful link redirects</a>
